...
class PredictionConvolutions(nn.Module):
    ...
    def __init__(self, n_classes):
        ...
        self.loc_conv6 = nn.Conv2d(32, n_boxes['conv6'] * 4, kernel_size=3, padding=1)
        self.loc_conv7 = nn.Conv2d(56, n_boxes['conv6'] * 4, kernel_size=3, padding=1)
        self.loc_conv8 = nn.Conv2d(112, n_boxes['conv7'] * 4, kernel_size=3, padding=1)
        self.loc_conv9 = nn.Conv2d(160, n_boxes['conv8'] * 4, kernel_size=3, padding=1)
        self.loc_conv10 = nn.Conv2d(272, n_boxes['conv9'] * 4, kernel_size=3, padding=1)

        # Class prediction convolutions (predict classes in localization boxes)
        self.cl_conv4_3 = nn.Conv2d(24, n_boxes['conv4_3'] * n_classes, kernel_size=3, padding=1)
        self.cl_conv6 = nn.Conv2d(32, n_boxes['conv6'] * n_classes, kernel_size=3, padding=1)
        self.cl_conv7 = nn.Conv2d(56, n_boxes['conv6'] * n_classes, kernel_size=3, padding=1)
        self.cl_conv8 = nn.Conv2d(112, n_boxes['conv7'] * n_classes, kernel_size=3, padding=1)
        self.cl_conv9 = nn.Conv2d(160, n_boxes['conv8'] * n_classes, kernel_size=3, padding=1)
        self.cl_conv10 = nn.Conv2d(272, n_boxes['conv9'] * n_classes, kernel_size=3, padding=1)
...
class SSD300(nn.Module):
    ...
    def __init__(self, n_classes):
        ...
        self.rescale_factors = nn.Parameter(torch.FloatTensor(1, 24, 1, 1))  # there are 512 channels in conv4_3_feats
    ...
    def forward(self, image):
        ...
        conv4_3_feats, conv6_feats , conv7_feats,d,e,f= self.base(image)  # (N, 512, 38, 38), (N, 1024, 19, 19)
        ...
        a,b,c,conv8_feats, conv9_feats, conv10_feats = \
            self.base(image) # (N, 512, 10, 10),  (N, 256, 5, 5), (N, 256, 3, 3), (N, 256, 1, 1)

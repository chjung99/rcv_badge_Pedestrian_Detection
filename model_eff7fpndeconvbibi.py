...
#         self.deconv3_bn= nn.BatchNorm2d(56, affine=True)
        ...
        self.deconv3_bn= nn.BatchNorm2d(56, affine=True)
        self.deconv2=nn.ConvTranspose2d(56,32,kernel_size=2,stride=2)
        self.deconv2_bn= nn.BatchNorm2d(32, affine=True)
        self.deconv1=nn.ConvTranspose2d(32,24,kernel_size=2,stride=2)
        self.deconv1_bn= nn.BatchNorm2d(24, affine=True)
        self.deconv0=nn.ConvTranspose2d(24,3,kernel_size=2,stride=2)
        self.deconv0_bn= nn.BatchNorm2d(3, affine=True)
    ...
    def forward(self, image):
        ...
        cfeat2=(self.deconv2_bn(self.deconv2(feat2)))
        
        feat1=(cfeat2+features[1])
        cfeat1=(self.deconv1_bn(self.deconv1(feat1)))
        
        feat0=(cfeat1+features[0])
        cfeat0=(self.deconv0_bn(self.deconv0(feat0)))
        
        featimage=cfeat0
        
        rfeatures = self.efficientNet(featimage)
        
        
        
        
        rfeat6=rfeatures[6]
        rcfeat6=(self.deconv6_bn(self.deconv6(rfeat6)))
        
        rfeat5=rcfeat6+rfeatures[5]
        rcfeat5=(self.deconv5_bn(self.deconv5(rfeat5)))
        
        rfeat4=(rcfeat5+rfeatures[4])
        rcfeat4=(self.deconv4_bn(self.deconv4(rfeat4)))
        
        rfeat3=(rcfeat4+rfeatures[3])
        rcfeat3=(self.deconv3_bn(self.deconv3(rfeat3)))
        
        rfeat2=(rcfeat3+rfeatures[2])
        
        
        kfeat2= F.relu(self.conv1_bn(self.conv1(feat2+rfeat2)))
        kfeat3= F.relu(self.conv2_bn(self.conv2(feat3+rfeat3)))
        kfeat4= F.relu(self.conv3_bn(self.conv3(feat4+rfeat4)))
        
        return kfeat2,kfeat3,kfeat4

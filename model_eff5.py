...
class AuxiliaryConvolutions(nn.Module):
    ...
    def __init__(self):
        ...
        self.conv8_1 = nn.Conv2d(160, 256, kernel_size=1, stride=2)
...
class PredictionConvolutions(nn.Module):
    ...
    def __init__(self, n_classes):
        ...
        self.loc_conv4_3 = nn.Conv2d(56, n_boxes['conv4_3'] * 4, kernel_size=3, padding=1)
        self.loc_conv6 = nn.Conv2d(112, n_boxes['conv6'] * 4, kernel_size=3, padding=1)
        self.loc_conv7 = nn.Conv2d(160, n_boxes['conv6'] * 4, kernel_size=3, padding=1)
        ...
        self.cl_conv4_3 = nn.Conv2d(56, n_boxes['conv4_3'] * n_classes, kernel_size=3, padding=1)
        self.cl_conv6 = nn.Conv2d(112, n_boxes['conv6'] * n_classes, kernel_size=3, padding=1)
        self.cl_conv7 = nn.Conv2d(160, n_boxes['conv6'] * n_classes, kernel_size=3, padding=1)
...
class SSD300(nn.Module):
    ...
    def __init__(self, n_classes):
        ...
        self.rescale_factors = nn.Parameter(torch.FloatTensor(1, 56, 1, 1))  # there are 512 channels in conv4_3_feats

...
class AuxiliaryConvolutions(nn.Module):
    ...
    def __init__(self):
        ...
        self.conv8_bn=nn.BatchNorm2d(512, affine=True)
        # stride = 1, by default
 
        self.conv9_1 = nn.Conv2d(512, 256, kernel_size=1)
        self.conv9_2 = nn.Conv2d(256, 512, kernel_size=3, padding=1, bias=True)
        self.conv9_bn=nn.BatchNorm2d(512, affine=True)

        self.conv10_1 = nn.Conv2d(512, 256, kernel_size=1)
        self.conv10_2 = nn.Conv2d(256, 512, kernel_size=3, padding=1, bias=True)
        self.conv10_bn=nn.BatchNorm2d(512, affine=True)
        
        self.deconv10=nn.ConvTranspose2d(512,512,kernel_size=1,stride=1)
        self.deconv10_bn= nn.BatchNorm2d(512, affine=True)
        
        self.deconv9=nn.ConvTranspose2d(512,512,kernel_size=1,stride=1)
        self.deconv9_bn= nn.BatchNorm2d(512, affine=True)
    ...
    def forward(self, conv7_feats):
        ...
        feat8 = (self.conv8_1(conv7_feats))
        feat8  = F.relu(self.conv8_bn(self.conv8_2(feat8)))
        
        feat9 = (self.conv9_1(feat8))
        feat9 = F.relu(self.conv9_bn(self.conv9_2(feat9))) 

        feat10 = (self.conv10_1(feat9)) 
        feat10 = F.relu(self.conv10_bn(self.conv10_2(feat10)))
        
        conv10_feats=feat10
        
        cfeat10=F.relu(self.deconv10_bn(self.deconv10(feat10)))
        
        vfeat9=feat9+cfeat10
        
        conv9_feats=vfeat9
        
        cfeat9=F.relu(self.deconv9_bn(self.deconv9(vfeat9)))
        vfeat8=feat8+cfeat9

...
class VGGBase(nn.Module):
    ...
    def __init__(self, version=0):
        ...
        self.conv1=nn.Conv2d(112,512,kernel_size=3,padding=1,bias=True)
        self.conv1_bn= nn.BatchNorm2d(512, affine=True)
        
        
        
        self.conv2=nn.Conv2d(160,512,kernel_size=3,padding=1,bias=True)
        self.conv2_bn= nn.BatchNorm2d(512, affine=True)
        
        
        self.conv3=nn.Conv2d(272,512,kernel_size=3,padding=1,bias=True)
    ...
    def forward(self, image):
        ...
        feat2= F.relu(self.conv1_bn(self.conv1(features[3])))
        feat3= F.relu(self.conv2_bn(self.conv2(features[4])))
        feat4= F.relu(self.conv3_bn(self.conv3(features[5])))

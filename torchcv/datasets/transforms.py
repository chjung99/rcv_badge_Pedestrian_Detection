...
class Resize(object):
    def __call__(self,image,mask,boxes):
            ...
            # Resize image
            new_image = FT.resize(image, [1024, 1280])
            
            # Resize bounding boxes
#             old_dims = torch.FloatTensor([image.width, image.height, image.width, image.height,1]).unsqueeze(0)
...
#                 import pdb;pdb.set_trace()
#                 new_dims = torch.FloatTensor([dims[1], dims[0], dims[1], dims[0]],1).unsqueeze(0)
#                 new_boxes = new_boxes * new_dims

            return new_image,mask,boxes
